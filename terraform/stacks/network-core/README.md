...
The shared managed VLAN catalog for the nested interface and DHCP roots is committed in [`vlans.yaml`](/Users/bohdy/git/sk-home/terraform/stacks/network-core/vlans.yaml) and owns VLAN IDs, RouterOS interface names, and canonical comments.
