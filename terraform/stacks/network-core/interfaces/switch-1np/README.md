...
This root manages `Switch 1NP` interface topology and metadata in its own
...
This root owns the Switch 1NP interface concerns that should be planned and
...
The shared non-secret Switch 1NP interface configuration is committed in
