...
- Keep Switch 1PP tagged and untagged port membership in `bridge_ports`, keep outage-sensitive bridge VLAN rows in explicit `bridge_vlans`, and reserve `device_vlans` for VLAN-interface ownership only.
