...
# Describe the UniFi site or controller scope managed by this stack.
variable "wireless_site_name" {
  description = "Logical wireless site name used by the wifi stack."
  type        = string
  default     = "primary"
}
