...
Run the repository-defined formatter, lint, and validation commands that apply to the changed files. Report the files changed, commands run, outcomes, assumptions, and remaining risks. Do not commit, push, merge, dispatch workflows, query secrets, or apply infrastructure.
