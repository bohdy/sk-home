...
- [ ] Complete live acceptance of the declarative UniFi Poller configuration added after the controller migration, retaining controller-level metrics beyond access-point SNMP without duplicating device coverage.
