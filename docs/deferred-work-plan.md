...
- [ ] Apply the verified RouterOS firewall baseline adoption, remove its temporary import blocks, and confirm a clean follow-up plan with representative access tests. Then design and implement the separate default-deny input and forward policy before [issue #302](https://github.com/bohdy/sk-home/issues/302); work is tracked in [issue #301](https://github.com/bohdy/sk-home/issues/301).
