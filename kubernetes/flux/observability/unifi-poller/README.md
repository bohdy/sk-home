...
Create the Kubernetes Secret before resuming the Flux stage:
...
Resume the Flux stage after the Secret exists:
...
Render and validate the component before resuming Flux:
...
Rollback suspends the Flux Kustomization and leaves the manually bootstrapped Secret in place for the next resume.
